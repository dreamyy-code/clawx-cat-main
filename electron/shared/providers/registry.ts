...
import { ITERATIVECAT_DEFAULT_RUNTIME_BASE_URL } from '../../utils/build-profile';
...
export const PROVIDER_DEFINITIONS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    defaultBaseUrl: ITERATIVECAT_DEFAULT_RUNTIME_BASE_URL,
    showBaseUrl: true,
    showModelId: true,
    modelIdPlaceholder: 'gemini-3-flash-preview',
    defaultModelId: 'gemini-3-flash-preview',
    category: 'compatible',
    envVar: 'ITERATIVECAT_API_KEY',
    supportedAuthModes: ['api_key'],
    defaultAuthMode: 'api_key',
    supportsMultipleAccounts: false,
    providerConfig: {
      baseUrl: ITERATIVECAT_DEFAULT_RUNTIME_BASE_URL,
      api: 'openai-completions',
      apiKeyEnv: 'ITERATIVECAT_API_KEY',
    },
  },
  {
    id: 'ark',
