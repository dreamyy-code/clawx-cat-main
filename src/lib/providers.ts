 ...
 */
import { ITERATIVECAT_DEFAULT_RUNTIME_BASE_URL } from '@/config/build-profile';
...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'iterativecat', name: '迭代猫', icon: '🐾', placeholder: 'itc-...', model: 'Multi-Model', requiresApiKey: false, defaultBaseUrl: ITERATIVECAT_DEFAULT_RUNTIME_BASE_URL, showBaseUrl: true, showModelId: true, modelIdPlaceholder: 'gemini-3-flash-preview', defaultModelId: 'gemini-3-flash-preview', docsUrl: 'https://www.iterativecat.cn/' },
