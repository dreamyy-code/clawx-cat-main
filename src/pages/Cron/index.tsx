...
function SelectField({ className, children, ...props }: SelectFieldProps) {
  return (
    <div className="relative">
      <Select
        className={cn(
          'app-field h-[44px] rounded-xl border text-[13px] pr-10 [background-image:none] appearance-none',
          className,
        )}
        {...props}
      >
...
function TaskDialog({ job, configuredChannels, onClose, onSave }: TaskDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50  flex items-center justify-center p-4" onClick={onClose}>
      <Card className="app-panel w-full max-w-lg max-h-[90vh] flex flex-col rounded-3xl border overflow-hidden" onClick={(e) => e.stopPropagation()}>
        <CardHeader className="flex flex-row items-start justify-between pb-2 shrink-0">
          ...
          <Button variant="ghost" size="icon" onClick={onClose} className="rounded-full h-8 w-8 -mr-2 -mt-2 text-muted-foreground hover:text-foreground hover:bg-card">
            <X className="h-4 w-4" />
          </Button>
        </CardHeader>
        <CardContent className="space-y-6 pt-4 overflow-y-auto flex-1 p-6">
          ...
          <div className="space-y-2.5">
            ...
            <Input
              ...
              className="app-field h-[44px] rounded-xl font-mono text-[13px] border focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary shadow-sm transition-all text-foreground placeholder:text-foreground/40"
            />
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <Textarea
              ...
              rows={3}
              className="app-field rounded-xl font-mono text-[13px] border focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary shadow-sm transition-all text-foreground placeholder:text-foreground/40 resize-none"
            />
          </div>
          ...
          <div className="space-y-2.5">
            ...
            {!useCustom ? (
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      schedule === preset.value
                        ...
                        : "bg-background border-border/70 hover:bg-card text-foreground/80 hover:text-foreground"
                    )}
                  >
              ...
              <Input
                ...
                className="h-[44px] rounded-xl font-mono text-[13px] bg-card dark:bg-muted border-border dark:border-white/10 focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary shadow-sm transition-all text-foreground placeholder:text-foreground/40"
              />
            )}
            <div className="flex items-center justify-between mt-2">
              ...
              <Button
                ...
                className="text-[12px] h-7 px-2 text-foreground/60 hover:text-foreground hover:bg-card rounded-lg"
              >
          ...
          {/* Enabled */}
          <div className="flex items-center justify-between bg-card dark:bg-muted p-4 rounded-2xl shadow-sm border border-border/50 dark:border-white/5">
            <div>
...
function CronJobCard({ job, deliveryAccountName, onToggle, onEdit, onDelete, onTrigger }: CronJobCardProps) {
  ...
  return (
    <div
      className="group flex flex-col p-5 rounded-2xl bg-card border border-border/40 shadow-sm hover:shadow-md hover:border-border/60 transition-all relative overflow-hidden cursor-pointer"
      onClick={onEdit}
    >
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-4">
          <div className="h-[46px] w-[46px] shrink-0 flex items-center justify-center text-foreground bg-black/5 dark:bg-white/5 border border-border/50 dark:border-white/10 rounded-full shadow-sm group-hover:scale-105 transition-transform">
...
export function Cron() {
  ...
  return (
    <div data-testid="cron-page" className="flex flex-col h-full overflow-hidden bg-background">
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto w-full max-w-7xl px-5 py-6 md:px-6 md:py-8 space-y-5">
          ...
          <div className="flex items-center gap-3 md:mt-2">
            <Button
              ...
              className="h-9 text-[13px] font-medium rounded-full px-4 border-border dark:border-white/10 bg-transparent hover:bg-black/5 dark:hover:bg-white/5 shadow-none text-foreground/80 hover:text-foreground transition-colors"
            >
        ...
        <div className="flex-1 overflow-y-auto pb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="p-5 rounded-3xl bg-card border border-border/40 shadow-sm flex flex-col justify-between min-h-[130px] relative overflow-hidden group hover:shadow-md transition-all">
