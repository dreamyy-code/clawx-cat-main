...
if /i "%1"=="update" (
    set "_ALLOW_UPDATE_TAG=0"
    echo %_ARGS% | findstr /i /c:"--tag" >nul && set "_ALLOW_UPDATE_TAG=1"
    if not "!_ALLOW_UPDATE_TAG!"=="1" (
